                        ...
                        <div class="footer-logo-support d-md-flex align-items-end justify-content-between">
                            <div class="footer-logo d-flex align-items-end">
                                ...
                                <ul class="social mt-30">
                                   <li><a href="https://www.instagram.com/_tirth_bhatt_official/?hl=en"><i class="lni-instagram-original"></i></a></li>
                                </ul>
                            </div> <!-- footer logo -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p class="text">Managed By <a rel="nofollow" href="#">Tirth Bhatt</a></p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->

            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-10">
                        <h4 class="title">Tirth Bhatt</h4>
                        <p class="text">Services Are Here...</p>
                    </div> <!-- section title -->
                <div class="row">
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="services-content mt-40 d-sm-flex">
                                <div class="services-content media-body">
                                    ...
                                    <p class="text">PHP HTML Javascript.</p>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="services-content mt-40 d-sm-flex">
                                <div class="services-content media-body">
                                    <h4 class="services-title">Java Development</h4>
                                    <p class="text">java based all applications are make.</p>
                                </div>
                            </div> <!-- services content -->
                        </div>
                    </div> <!-- row -->
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing mt-40">
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Tirth Bhatt</h5>
                            <span class="price">Web Developer</span>
                            <p class="year"></p>
                        </div>
                       
                        <div class="pricing-btn text-center">
                            <a class="main-btn" href="#">More Details</a>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing pro mt-40">
                        ...
                        <div class="pricing-header">
                            <h5 class="sub-title">Drashti Patel</h5>
                            <span class="price">Python Developer</span>
                            <p class="year"></p>
                        </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="single-pricing enterprise mt-40">
                        ...
                        <div class="pricing-header text-right">
                            <h5 class="sub-title">Pratham Parekh</h5>
                            <span class="price">Java Developer</span>
                            <p class="year"></p>
                        </div>
